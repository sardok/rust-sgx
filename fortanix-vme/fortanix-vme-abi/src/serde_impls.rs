//! We can't rely on the `serde::{Deserialize, Serialize}` macros as we wish to
//! use this crate in the standard library.
//! See <https://github.com/rust-lang/rust/issues/64671> This implementation is
//! based on the expanded `serde` macros.
